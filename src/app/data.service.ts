...
export class DataService {
  ...
  createAdvancedUser(newUser: Omit<AdvancedUser, 'id'>): void {
    const userWithId: AdvancedUser = {
      ...newUser,
  ...
  updateAdvancedUser(updatedUser: AdvancedUser): void {
  ...
  deleteAdvancedUser(id: string): void {
